...
import EVENT_DATA_TYPE_DESCRIPTIONS from '../event-data/reward.json';
...
export default class Methods {
	...
	*/
	"mintTo" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "rewardController::mintTo", (events: EventRecord) => {
	...
	*/
	"burnRewards" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "rewardController::burnRewards", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);
		}, [amount], __options);
	}
