...
import type * as ArgumentTypes from '../types-arguments/payment copy';
import type * as ReturnTypes from '../types-returns/payment copy';
...
import DATA_TYPE_DESCRIPTIONS from '../data/payment copy.json';
import EVENT_DATA_TYPE_DESCRIPTIONS from '../event-data/payment copy.json';
