...
export default class Methods {
	...
	*/
	"mintTo" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "rewardController::mintTo", [account, amount], __options);
	}
	...
	*/
	"burnRewards" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "rewardController::burnRewards", [amount], __options);
	}
