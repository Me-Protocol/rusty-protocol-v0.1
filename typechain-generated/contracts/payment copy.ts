...
import { ContractAbi } from '../contract-info/payment copy';
import QueryMethods from '../query/payment copy';
import BuildExtrinsicMethods from '../build-extrinsic/payment copy';
import TxSignAndSendMethods from '../tx-sign-and-send/payment copy';
import MixedMethods from '../mixed-methods/payment copy';
import EventsClass from '../events/payment copy';
