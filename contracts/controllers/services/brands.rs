...
pub trait BrandController {
    ...
    #[ink(message)]
    fn register(&mut self, name: Option<String>, online_presence: Option<String>) -> Result<(), ProtocolError>;
    ...
    #[ink(message)]
    fn update_reward_config(&mut self, reward_address: AccountId, reward_config: RewardConfig, ignore_default:bool) -> Result<bool, ProtocolError>;
    ...
    #[ink(message)]
    fn add_bounty_manager(&mut self, reward_address: AccountId, bounty_manager:AccountId ) -> Result<bool, ProtocolError>;


    #[ink(message)]
    fn remove_bounty_manager(&mut self, reward_address: AccountId, bounty_manager:AccountId ) -> Result<bool, ProtocolError>;

    
    #[ink(message)]
    fn add_pool_manager(&mut self, reward_address: AccountId, pool_manager:AccountId ) -> Result<bool, ProtocolError>;
    ...
    #[ink(message)]
    fn integrate_existing_reward(&mut self, reward_address: AccountId, reward_description_link:Option<String>, read_t_and_c: bool ) -> Result<bool, ProtocolError>;
    ...
    #[ink(message)]
    fn update_pool_configuration(&mut self, reward_address: AccountId, editable_pool_config:EditablePoolConfig, ignore_default:bool)-> Result<bool, ProtocolError>;
    ...
    #[ink(message)]
    fn top_up_pool_balances(&mut self, reward_address: AccountId, reward_amount:Balance, me_amount:Balance)-> Result<bool, ProtocolError>;
